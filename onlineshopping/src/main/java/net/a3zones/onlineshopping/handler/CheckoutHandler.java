package net.a3zones.onlineshopping.handler;
...
import net.a3zones.onlineshopping.model.CheckoutModel;
import net.a3zones.onlineshopping.model.UserModel;
import net.a3zones.shoppingbackend.dao.CartLineDAO;
import net.a3zones.shoppingbackend.dao.ProductDAO;
import net.a3zones.shoppingbackend.dao.UserDAO;
import net.a3zones.shoppingbackend.dto.Address;
import net.a3zones.shoppingbackend.dto.Cart;
import net.a3zones.shoppingbackend.dto.CartLine;
import net.a3zones.shoppingbackend.dto.OrderDetail;
import net.a3zones.shoppingbackend.dto.OrderItem;
import net.a3zones.shoppingbackend.dto.Product;
